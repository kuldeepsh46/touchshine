...
class Pwcdcommission extends CI_Model
{
    ...
    {
        $commisionRate = $this->db->get_where('icdpcomission', array('package' => $utype, 'froma<=' => $amount, 'toa>=' => $amount))->row()->amount;
