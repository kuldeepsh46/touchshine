...
<div class="row">
                ...
                <div class="card-body">
                    <div class="row">
                                        ...
                                        <p style="background-color: white; border: dotted 1px #676f6f; text-align: center; padding: 7px; font-size: 16px; width: 52%; margin: auto; height: 40px;">
                                            <span>
                                                <?php
                                                  ...
                                                  echo '<span id="lbltodayMtAmount" style="color:Black;font-weight:bold;"></span>'; 
                                                ?>
                                            </span>
                                        </p>
                                    </div>
                            ...
                            <div class="info-box-4 hover-expand-effect">
                                <div class="content">
                                    ...
                                    <div class="box" style="height: 130px;">
                                        ...
                                        <p style="background-color: white; border: dotted 1px #676f6f; text-align: center; padding: 7px; font-size: 16px; width: 52%; margin: auto; height: 40px;">
                                            <span>
                                                <span id="lbltodayvr" style="color:Black;font-weight:bold;"></span></span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box-4 hover-expand-effect">
                                <div class="content">
                                    <a href= "/admin/transpanreg"</a>
                                    <div class="box" style="height: 130px;">
                                        <p style="margin: 10px; text-align: center; color: #020202; font-size: 16px; background-color: FFA500; padding: 5px; color: #000000; font-weight: bold;">
                                            <span style="font-size: 14px;">UTI Pan Registration Pending</span>
                                        </p>
                                        <p style="margin: 10px; text-align: center; color: #020202;">
                                        </p>
                                        <p style="background-color: white; border: dotted 1px #676f6f; text-align: center; padding: 7px; font-size: 16px; width: 52%; margin: auto; height: 40px;">
                        ...
                        <span id="lbltodayqraccount" style="color:Black;font-weight:bold;"><?php echo $usercnt['active_users']?></span>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="info-box-4 hover-expand-effect">
                                    <div class="content">
                                        <a href= "/admin/listuser"</a>
                                        <div class="box" style="height: 230px;">
                                            <p style="margin: 10px; text-align: center; color: #020202; font-size: 16px; background-color: 006400; padding: 5px; color: white; font-weight: bold;">
                                                <span id="ContentPlaceHolder1_Label17" style="font-size: 14px;">Total Partner</span>
                                            </p>
                                            <p style="margin: 10px; text-align: center; color: #020202;">
                                                <span id="ContentPlaceHolder1_Label18">Active Partner</span>
                                            </p>
                                            <p style="background-color: white; border: dotted 1px #676f6f; text-align: center; padding: 7px; font-size: 16px; width: 52%; margin: auto; height: 40px;">
                                                <span>
 ...
 <?php
                                            ...
                                            <p style="margin: 10px; text-align: center; color: #020202;">
                                                <span>Pending For Onboarding</span>
                                            </p>
                                            <p style="background-color: white; border: dotted 1px #676f6f; text-align: center; padding: 7px; font-size: 16px; width: 52%; margin: auto; height: 40px;">
                                                <span>
                                ...
                                <div class="info-box-4 hover-expand-effect">
                                    <div class="content">
                                        ...
                                        <div class="box" style="height: 230px;">
                                            ...
                                            <p style="background-color: white; border: dotted 1px #676f6f; text-align: center; padding: 7px; font-size: 16px; width: 52%; margin: auto; height: 40px;">
                                                <span>
                                                    <span id="lbltodayMtAmount" style="color:Black;font-weight:bold;">0.00</span></span>
                                            </p>
                                            <p style="margin: 10px; text-align: center; color: #020202;">
                                            ...
                                            <p style="background-color: white; border: dotted 1px #676f6f; text-align: center; padding: 7px; font-size: 16px; width: 52%; margin: auto; height: 40px;">
                                                <span>
                                                    <span id="lbltodayMTcount" style="color:Black;font-weight:bold;">0</span></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
