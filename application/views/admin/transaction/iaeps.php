							...
							<div class="col-md-12 col-lg-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title">ICICI AEPS TRANSACTION</div>
									...
									<div class="card-body">
										<div class="table-responsive">
											<table id="example" class="table table-bordered key-buttons text-nowrap">
												...
												<?php  
												$data = $this->db->from("iaepstxn")->where('date >=',$from)->where('date <=',$to)->order_by('id',"DESC")->get()->result(); ?>
												<tbody>
												    <?php $ind = 1; ?>
													...
													<tr>
														...
														<td><?php echo $this->db->get_where('banks',array('id' => $dat->bank))->row()->name; ?></td>
