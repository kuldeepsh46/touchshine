            ...
            <?php $user = $this->db->get_where('users',array('id' => $_SESSION['uid']))->row(); ?>
             ...
             <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <span><i class="fa fa-check" aria-hidden="true"></i><?php echo $balance; ?></span>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <span><i class="fa fa-check" aria-hidden="true"></i><?php print_r($ms); ?></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php $ind = 1; ?>
                        <?php foreach($dat as $da) : ?>
                        <tr <?php if($dat->txnType == "Dr"){  ?>style="color: red;"<?php } ?>>
                            <th><?php echo $ind;  ?></th>
                            <th><?php echo $da->date;  ?></th>
                            <th><?php echo $da->txnType;  ?></th>
                            <th><?php echo $da->amount;  ?></th>
                             <th><?php echo $da->narration;  ?></th>
                        </tr>
                        <?php $ind++; ?>
                        <?php endforeach; ?>
                    </tbody>
