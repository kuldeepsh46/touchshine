                    ...
                    <div class="card-body">
                        <div class="card-body">
                            <form class="form-horizontal" >
                                ...
                                <div class="form-group row">
                                    <label for="inputEmai2" class="col-md-3 col-form-label">State</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="state" placeholder="State"disabled value="<?php echo $kyc->state; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="inputEmai2" class="col-md-3 col-form-label">Aadhar Number</label>
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" id="aadhar" placeholder="Aadhar Number"disabled value="<?php echo $kyc->adhaar; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
