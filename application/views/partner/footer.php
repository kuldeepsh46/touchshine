			...
			<footer class="footer-main icon-footer">
				<div class="container">
					<div class="  mt-2 mb-2 text-center">
						Copyright © 2018 <a href="#" class="fs-14 text-primary"><?php echo $title; ?></a>. Designed by <a href="https://moonexmoney.com/" class="fs-14 text-primary">Moonex Software</a> All rights reserved.
					</div>
				</div>
			</footer>
			<!-- Footer closed -->
