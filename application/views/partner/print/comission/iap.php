	<?php
	$comdatas = $this->db->get_where('icapcharge',array('package' => $pk))->result();
	
	
	
	?>
	
	<h5 class="card-title">ICICI AADHARPAY CHARGE</h5>
								
								<hr class="my-2">
									<form action="/partnercommission/iap" method="POST">
