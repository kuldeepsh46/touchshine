	<?php
	$comdatas = $this->db->get_where('payoutchargeneft',array('package' => $pk))->result();
	
	
	
	?>
	
	<h5 class="card-title">PAYOUT CHARGE NEFT</h5>
								
								<hr class="my-2">
									<form action="/partnercommission/payoutneft" method="POST">
