	<?php
	$comdatas = $this->db->get_where('icdpcomission',array('package' => $pk))->result();
	
	
	
	?>
	
	<h5 class="card-title">ICICI CASH DEPOSIT COMISSION</h5>
								
								<hr class="my-2">
									<form action="/partnercommission/icd" method="POST">
