	<?php
	$comdatas = $this->db->get_where('adhaarpaycharge',array('package' => $pk))->result();
	
	
	
	?>
	
	<h5 class="card-title">INDUS AADHARPAY CHARGE</h5>
								
								<hr class="my-2">
									<form action="/partnercommission/nap" method="POST">
