	<?php
	$comdatas = $this->db->get_where('payoutchargeimps',array('package' => $pk))->result();
	
	
	
	?>
	
	<h5 class="card-title">PAYOUT CHARGE IMPS</h5>
								
								<hr class="my-2">
									<form action="/partnercommission/payoutimps" method="POST">
