	<?php
	$comdatas = $this->db->get_where('icaepscomission',array('package' => $pk))->result();
	
	
	
	?>
	
	<h5 class="card-title">ICICI CASH WITHDRWAL COMISSION</h5>
								
								<hr class="my-2">
									<form action="/partnercommission/icw" method="POST">
