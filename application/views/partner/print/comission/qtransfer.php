	<?php
	$comdatas = $this->db->get_where('qtransfer',array('package' => $pk))->result();
	
	
	
	?>
	
	<h5 class="card-title">QUICK TRANSFER CHARGE</h5>
								
								<hr class="my-2">
									<form action="/partnercommission/qtransfer" method="POST">
