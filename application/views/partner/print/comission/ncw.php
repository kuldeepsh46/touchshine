	<?php
	$comdatas = $this->db->get_where('aepscomission',array('package' => $pk))->result();
	
	
	
	?>
	
	<h5 class="card-title">INDUS CASH WITHDRAWAL COMISSION</h5>
								
								<hr class="my-2">
									<form action="/partnercommission/ncw" method="POST">
