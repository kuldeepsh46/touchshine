										...
										<div class="row">
											<div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
												<div class="card  box-shadow-0">
													<div class="card-header">
														<h4 class="card-title">Credit Fund</h4>
													</div>
													<div class="card-body">
														<form class="form-horizontal" >
															...
															<div class="form-group mb-0 mt-3 justify-content-end">
																<div>
																	<button type="button" class="btn btn-primary" onclick="credit();" id="crbtn">Credit</button>
																</div>
															</div>
														</form>
													</div>
...
<script>
    ...
    $('#crbtn').html(dat);
                    if(data  == 1)
                    {
                        alert("FUND CREDIT SUCCESSFULL");
                        location.href="/partner/credit";
