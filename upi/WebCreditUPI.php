...
$credited_at = $post->created_at;
$bene_account_no = $post->payee_vpa;
$bene_account_ifsc = $post->order_id;
$rmtr_full_name = $post->payer_name;
$rmtr_account_no = $post->source;
$rmtr_account_ifsc = $post->payer_mobile;
$rmtr_to_bene_note = $post->payer_note;
$txn_id = $post->id;
$amount = $post->amount;
