        ...
        function CallCapture(device,path) {
...
function CallApi(BiometricData,path) {
 ...
 var device  = sessionStorage.getItem("device");
	...
	if(path == "BE")
	{
	    ...
	    $.post( "/iciciaeps/be",trfdata,function( data ) {
	...
	if(path == "MS")
	{
        ...
        trfdata.phone = phone; 
	     ...
	     $.post( "/iciciaeps/msi",trfdata,function(data) {
	...
	if(path == "CW")
	{
        ...
        trfdata.amount = amount;
	     ...
	     $.post( "/iciciaeps/cw",trfdata,function(data) {
		...
		if(path == "AP")
	{
        ...
        trfdata.amount = amount;
	     ...
	     $.post( "/iciciaeps/ap",trfdata,function(data) {
