$(function () {
	...
	gradientStroke1.addColorStop(0, 'rgba(255, 187, 87,0.8)');

	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 190);
	gradientStroke2.addColorStop(0, 'rgba(255, 148, 76,0.4)');
	...
	var myDoughnutChart = new Chart(doughnut, {
		...
		datasets: [{
			...
			backgroundColor: ['rgba(34, 5, 191,0.8)','rgba(9, 176, 236,0.8)','rgba(249, 72, 89,0.9)','rgba(255, 171, 0,0.7)'],
			borderColor: ['rgba(34, 5, 191,0.2)','rgba(9, 176, 236,0.2)','rgba(249, 72, 89,0.4)','rgba(255, 171, 0,0.2)'],
		 }]
	   },
	  options: {
			maintainAspectRatio : false,
	...
	var option3 = {
		...
		series: chartdata,
		color: ['#0245da', 'rgba(9, 176, 236,0.8)' ]
	};
	...
	gradientStroke1.addColorStop(0, 'rgba(10, 144, 251,0.9)');
	gradientStroke1.addColorStop(1, 'rgba(10, 144, 251,0.9)');
